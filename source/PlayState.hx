	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			...
			case 'headspace' | 'reverie' | 'guilty':
			{
					...
					var whitespaceDoor:FlxSprite = new FlxSprite(475, 210).loadGraphic(Paths.image('whitespaceDoor'));
					whitespaceDoor.setGraphicSize(Std.int(whitespaceDoor.width * 1.0));
					whitespaceDoor.antialiasing = true;
					whitespaceDoor.scrollFactor.set(0.75, 0.75);
					whitespaceDoor.active = false;
					add(whitespaceDoor);

					var whitespaceLightbulbShade:FlxSprite = new FlxSprite(796.75, 120).loadGraphic(Paths.image('whitespaceLightbulbShade'));
					whitespaceLightbulbShade.setGraphicSize(Std.int(whitespaceLightbulbShade.width * 0.60));
					...
					var whitespaceLightbulb:FlxSprite = new FlxSprite(925, -565).loadGraphic(Paths.image('whitespaceLightbulb'));
					whitespaceLightbulb.setGraphicSize(Std.int(whitespaceLightbulb.width * 0.60));
